...
OUTPUTFILE = '../Data/features-2017-04-25-v02.csv'
...
# make dummies for words count
# then drop the column with bins
...
df.drop('pct_shared_bins', axis=1, inplace=True)
df = df.join(dummies)


# remove useless columns
useless_col = ['id', 'qid1', 'qid2', 'question1', 'question2', 'tokens1', 'tokens2', 'qword1', 'qword2']
